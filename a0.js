...
<body>
    ...
    <script>
        ...
        shareBtn.addEventListener('click', () => {
           ...
           现代化博客文章模板: `<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>博客文章 - 现代化模板</title>
    <style>
        /* 全局样式 */
        body {
...
<body>
    ...
    <div class="container main-content">
        ...
        <article>
            <h1>现代化博客文章示例</h1>
            <p>欢迎体验这个美观且现代化的博客模板！本文将展示如何使用 HTML 和 CSS 创建一个优雅的博客布局，包含页眉、页脚和动态目录。</p>
            
            <h2 id="section1">第一部分：设计理念</h2>
            <p>本模板采用简洁的设计语言，结合响应式布局，确保在桌面和移动设备上均有良好体验。深色模式切换功能提升了用户友好性。</p>
            <img src="https://via.placeholder.com/600x300" alt="示例图片">

            <h2 id="section2">第二部分：功能亮点</h2>
            <p>模板包含以下功能：</p>
            <ul>
                <li>动态目录（TOC），自动生成文章导航</li>
                <li>深色模式切换，保护用户眼睛</li>
                <li>响应式设计，适配多种设备</li>
                <li>优雅的页眉和页脚，增强品牌感</li>
            </ul>

            <h2 id="section3">第三部分：如何使用</h2>
            <p>只需复制此 HTML 代码，替换文章内容和图片链接，即可快速搭建一个现代化博客。CSS 样式可根据需求调整，例如更改颜色或字体。</p>
        </article>
        ...
        <aside>
            <div class="toc">
                <h3>目录</h3>
                <ul>
                    <li><a href="#section1">第一部分：设计理念</a></li>
                    <li><a href="#section2">第二部分：功能亮点</a></li>
                    <li><a href="#section3">第三部分：如何使用</a></li>
                </ul>
            </div>
        </aside>
    </div>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2025 我的博客 | 由 <a href="#">Grok</a> 提供技术支持</p>
        </div>
    </footer>
